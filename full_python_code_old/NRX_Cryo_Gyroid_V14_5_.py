...
def gyroid(x, y, z, freq):
    return (
        ...
        np.sin(freq*z)*np.cos(freq*x)  # <-- تمت إضافة القوس الناقص هنا
    )
...
class GyroidGenerator:
    ...
    def generate(self, args):
        ...
        try:
            ...
            print("Solutions: 1. Reduce resolution 2. Decrease buffer 3. Use --safe")
            return None
...
def main():
    parser = argparse.ArgumentParser(description="NRX Cryo-Gyroid Generator")
